...
void DialogBoxremoveplaylist(BuildContext context, index) {
  showDialog(
    context: context,
    builder: (context) => AlertDialog(
      shape: RoundedRectangleBorder(
...
void DialogBoxremoverecentlist(BuildContext context, index) {
  showDialog(
    context: context,
    builder: (context) => AlertDialog(
      shape: RoundedRectangleBorder(
